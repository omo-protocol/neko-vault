...
contract DeployPTLoopVault is Script {
    // Strategy IDs
    bytes32 constant PT_LOOP_STRATEGY_ID = keccak256("option-vault");
    // Asset configuration
    address asset = 0xfD739d4e423301CE9385c1fb8850539D657C296D; // KHYPE
    address vaultFactoryAddress = 0xb5b700a8e4642F4c74E25225bC692D3db2C06395; // config to vault factory address
    address adapterFactoryAddress = 0xDC8E57133b0b818Daf13c4493d8fD574d8A1feC4; // config to adapter factory address
    address valuerAddress = 0xC8a3FBd714aD4200311551151b46d2EC1647D7B9; // config to valuer address
